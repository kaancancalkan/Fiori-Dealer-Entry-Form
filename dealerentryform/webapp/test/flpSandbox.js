		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dealer Entry Form",
									"targetURL": "#vol1dealerentryform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vol1dealerentryform-display": {
								"semanticObject": "vol1dealerentryform",
								"action": "display",
								"description": "Dealer entry form ",
								"title": "Dealer Entry Form",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vol1.dealerentryform",
									"url": sap.ui.require.toUrl("vol1/dealerentryform")
								}
							}
						}
					}
